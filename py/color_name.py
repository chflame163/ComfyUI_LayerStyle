...
class LS_ColorName:
    ...
    def INPUT_TYPES(self):
        palette_list = ['xkcd', 'css3', 'html4']
        return {
            "required": {
                "color": ("STRING", {"default": "#000000", "forceInput":True},),
    ...
    def get_color_name(self, color, palette):
        ...
        if palette == "xkcd":
            color_table = self.XKCD_NAME_TO_HEX
        elif palette == "css3":
            color_table = self.CSS3_NAMES_TO_HEX
        else:
            color_table = self.HTML4_NAMES_TO_HEX
        min_colors = {}
