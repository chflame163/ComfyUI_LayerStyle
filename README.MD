...
<font size="2">*this workflow (title_example_workflow.json) is in the workflow directory.  </font><br /> 
...
Create a gradient for the mask from one side.
...
<sup>3</sup> Preview of the blend mode
